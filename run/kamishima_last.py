...
for data_set, sensitive_variable in zip([adult_small], [adult_small.columns.get_loc('Gender_Male')]):
  ut.train_test_get_results_grid(data_set,sensitive_variable, Kamishima, {'fairness': [np.exp(i) for i in np.linspace(-2, 6, 100)]}, repeats = range(5))
